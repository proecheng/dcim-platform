<template>
  <div class="video-manage-page">
    ...
    <!-- NVR 新增/编辑对话框 -->
    <el-dialog v-model="nvrDialogVisible" :title="nvrForm.id ? '编辑NVR' : '新增NVR'" width="560px" destroy-on-close>
    ...
    <!-- 摄像头 新增/编辑对话框 -->
    <el-dialog v-model="camDialogVisible" :title="camForm.id ? '编辑摄像头' : '新增摄像头'" width="640px" destroy-on-close>
