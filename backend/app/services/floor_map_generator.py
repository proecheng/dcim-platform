...
FLOOR_CONFIG = {
    ...
    "F1": {"name": "1楼机房区A", "width": 50, "height": 40, "color": "#1e4d2b", "cabinets": 20, "rows": 4, "cols": 5},
    "F2": {"name": "2楼机房区B", "width": 50, "height": 35, "color": "#4a1e6b", "cabinets": 15, "rows": 3, "cols": 5},
    "F3": {"name": "3楼办公监控", "width": 45, "height": 30, "color": "#6b4a1e", "cabinets": 8, "rows": 2, "cols": 4},
}
...
class FloorMapGenerator:
    ...
    def generate_2d_map(self, floor_code: str, devices: List[Dict] = None) -> Dict[str, Any]:
        ...
        map_data = {
            ...
            "dimensions": {"width": config.get("width", 50), "height": config.get("height", 40)},
    ...
    def generate_3d_map(self, floor_code: str, devices: List[Dict] = None) -> Dict[str, Any]:
        ...
        map_data = {
            ...
            "camera": {"position": [25, 20, 35], "target": [25, 0, 20]},
            "objects": [],
        }
    ...
    def _generate_cooling_layout_3d(self, devices: List[Dict]) -> List[Dict]:
        ...
        # 地板
        objects.append({"type": "floor", "position": [20, 0, 15], "size": [40, 0.1, 30], "color": "#1a3a5c"})
