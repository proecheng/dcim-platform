...
DISTRIBUTION_CIRCUITS = [
    ...
    # 新增: F2楼层回路
    {
        "circuit_code": "C-F2-UPS-01",
        "circuit_name": "F2 UPS回路",
        "panel_code": "F2-PANEL-001",
        "load_type": "UPS",
        "rated_current": 200,
        "is_shiftable": False,
    ...
    # 新增: F3楼层回路
    {
        "circuit_code": "C-F3-UPS-01",
        "circuit_name": "F3 UPS回路",
        "panel_code": "F3-PANEL-001",
        "load_type": "UPS",
        "rated_current": 100,
        "is_shiftable": False,
...
POWER_DEVICES = [
    ...
    {
        "device_code": "F1-AC-001",
        "device_name": "F1 精密空调-1",
        "device_type": "AC",
        "rated_power": 30,
        "is_it_load": False,
        "area_code": "F1",
    ...
    {
        "device_code": "F1-AC-002",
        "device_name": "F1 精密空调-2",
        "device_type": "AC",
        "rated_power": 30,
        "is_it_load": False,
        "area_code": "F1",
    ...
    {
        "device_code": "F1-AC-003",
        "device_name": "F1 精密空调-3",
        "device_type": "AC",
        "rated_power": 30,
        "is_it_load": False,
        "area_code": "F1",
    ...
    {
        "device_code": "F1-AC-004",
        "device_name": "F1 精密空调-4",
        "device_type": "AC",
        "rated_power": 30,
        "is_it_load": False,
        "area_code": "F1",
    ...
    {
        "device_code": "F2-UPS-001",
        "device_name": "F2 UPS-1",
        "device_type": "UPS",
        "rated_power": 100,
        "is_it_load": False,
        "area_code": "F2",
    ...
    {
        "device_code": "F2-UPS-002",
        "device_name": "F2 UPS-2",
        "device_type": "UPS",
        "rated_power": 100,
        "is_it_load": False,
        "area_code": "F2",
    ...
    {
        "device_code": "F2-AC-001",
        "device_name": "F2 精密空调-1",
        "device_type": "AC",
        "rated_power": 30,
        "is_it_load": False,
        "area_code": "F2",
    ...
    {
        "device_code": "F2-AC-002",
        "device_name": "F2 精密空调-2",
        "device_type": "AC",
        "rated_power": 30,
        "is_it_load": False,
        "area_code": "F2",
    ...
    {
        "device_code": "F2-AC-003",
        "device_name": "F2 精密空调-3",
        "device_type": "AC",
        "rated_power": 30,
        "is_it_load": False,
        "area_code": "F2",
    ...
    {
        "device_code": "F2-AC-004",
        "device_name": "F2 精密空调-4",
        "device_type": "AC",
        "rated_power": 30,
        "is_it_load": False,
        "area_code": "F2",
    ...
    {
        "device_code": "F3-UPS-001",
        "device_name": "F3 UPS-1",
        "device_type": "UPS",
        "rated_power": 60,
        "is_it_load": False,
        "area_code": "F3",
    ...
    {
        "device_code": "F3-AC-001",
        "device_name": "F3 精密空调-1",
        "device_type": "AC",
        "rated_power": 20,
        "is_it_load": False,
        "area_code": "F3",
    ...
    {
        "device_code": "F3-AC-002",
        "device_name": "F3 精密空调-2",
        "device_type": "AC",
        "rated_power": 20,
        "is_it_load": False,
        "area_code": "F3",
...
class DemoDataService:
    ...
    async def load_demo_data(
        self, days: int = 30, progress_callback: Optional[Callable[[int, str], None]] = None
    ) -> dict:
        """加载演示数据（带进度回调）"""
        ...
        async with self._lock:
            ...
            try:
                ...
                if status["demo_point_count"] > 0:
                    ...
                    await self._clear_demo_data_safe()
        ...
        async with self._lock:
            ...
            try:
                async with async_session() as session:
                    ...
                    await session.execute(update(PointHistory).values(recorded_at=PointHistory.recorded_at + offset))
                    await session.commit()

                    # 更新PUEHistory日期
                    self._update_progress(85, "更新能耗数据日期...")
                    await session.execute(update(PUEHistory).values(record_time=PUEHistory.record_time + offset))
                    await session.commit()
        ...
        async with async_session() as session:
            ...
            for d in POWER_DEVICES:
                ...
                point_ids = PointDeviceMatcher.find_matching_points(
                    d["device_code"], d["device_name"], d.get("area_code", ""), point_map
                )
            ...
            for i, point in enumerate(points):
                ...
                for r in records:
                    ...
                    if len(batch_records) >= batch_size:
                        ...
                        self._update_progress(
                            min(progress, 84), f"生成历史数据 {total_records} 条...", progress_callback
                        )
    ...
    async def get_demo_data_stats(self) -> dict:
        """获取 demo 数据统计"""
        async with async_session() as session:
            stats = {}
            ...
            models = [
                ...
                (MeterPoint, "meter_points"),
                (DistributionPanel, "distribution_panels"),
                (DistributionCircuit, "distribution_circuits"),
                (PowerDevice, "power_devices"),
                (CoolingGroup, "cooling_groups"),
                (CoolingUnit, "cooling_units"),
                (ColdAisle, "cold_aisles"),
