...
UPS5000_TEMPLATE: dict[str, Any] = {
    ...
    "point_config": [
        ...
        _point(
            "output_voltage_a", "A phase output voltage", "HR:40046", "uint16", scale=0.1, unit="V", category="output"
        ),
        _point(
            "output_voltage_b", "B phase output voltage", "HR:40047", "uint16", scale=0.1, unit="V", category="output"
        ),
        _point(
            "output_voltage_c", "C phase output voltage", "HR:40048", "uint16", scale=0.1, unit="V", category="output"
        ),
        _point(
            "output_current_a", "A phase output current", "HR:40052", "uint16", scale=0.1, unit="A", category="output"
        ),
        _point(
            "output_current_b", "B phase output current", "HR:40053", "uint16", scale=0.1, unit="A", category="output"
        ),
        _point(
            "output_current_c", "C phase output current", "HR:40054", "uint16", scale=0.1, unit="A", category="output"
        ),
        _point("output_frequency", "Output frequency", "HR:40055", "uint16", scale=0.01, unit="Hz", category="output"),
        _point(
            "output_active_power_a",
            "A phase output active power",
            "HR:40056",
            "int16",
            scale=0.1,
            unit="kW",
...
FUSIONCOL5000A_TEMPLATE: dict[str, Any] = {
    ...
    "point_config": [
        ...
        _point(
            "unit_power_control", "Unit power on/off control", "HR:0x1880", "bool", category="control", writable=True
        ),
        ...
        _point(
            "dehumidifying_output", "Dehumidifying output", "HR:0x180E", "uint16", unit="%", category="dehumidifier"
        ),
        _point(
            "cooling_capacity", "Cooling capacity", "HR:0x1810:2", "uint32", scale=0.01, unit="kW", category="cooling"
        ),
        ...
        _point(
            "current_humidity", "Current humidity", "HR:0x2802", "uint16", scale=0.1, unit="%RH", category="environment"
        ),
        _point(
            "supply_air_avg_temperature",
            "Supply air average temperature",
            "HR:0x2803",
            "int16",
            scale=0.1,
            unit="degC",
        ...
        _point(
            "return_air_avg_temperature",
            "Return air average temperature",
            "HR:0x2804",
            "int16",
            scale=0.1,
            unit="degC",
        ...
        _point(
            "supply_air_avg_humidity",
            "Supply air average humidity",
            "HR:0x2807",
            "uint16",
            scale=0.1,
            unit="%RH",
        ...
        _point(
            "return_air_avg_humidity",
            "Return air average humidity",
            "HR:0x2808",
            "uint16",
            scale=0.1,
            unit="%RH",
        ...
        _point(
            "supply_air_high_temperature_alarm",
        ...
        _point(
            "supply_air_low_temperature_alarm",
            "Supply air low temperature alarm",
            "HR:0x0808.1",
            "bool",
            category="alarm",
        ),
        _point(
            "return_air_high_temperature_alarm",
        ...
        _point(
            "return_air_low_temperature_alarm",
            "Return air low temperature alarm",
            "HR:0x0808.7",
            "bool",
            category="alarm",
        ),
