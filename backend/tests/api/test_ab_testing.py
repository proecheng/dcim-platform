...
@pytest.mark.asyncio
async def test_create_ab_test_api(client: AsyncClient, admin_token: str, db_session: AsyncSession):
    """测试创建 A/B 测试 API"""
    # 创建故障树和版本
...
@pytest.mark.asyncio
async def test_create_ab_test_unauthorized(client: AsyncClient, db_session: AsyncSession):
    """测试未授权创建 A/B 测试"""
    response = await client.post(
        "/api/v1/diagnosis/ab-tests",
        json={
...
@pytest.mark.asyncio
async def test_list_ab_tests_api(client: AsyncClient, admin_token: str, db_session: AsyncSession):
    """测试列出 A/B 测试 API"""
    # 创建测试数据
...
@pytest.mark.asyncio
async def test_get_ab_test_api(client: AsyncClient, admin_token: str, db_session: AsyncSession):
    """测试查询单个 A/B 测试 API"""
    # 创建测试数据
...
@pytest.mark.asyncio
async def test_update_ab_test_api(client: AsyncClient, admin_token: str, db_session: AsyncSession):
    """测试更新 A/B 测试 API"""
    # 创建测试数据
...
@pytest.mark.asyncio
async def test_delete_ab_test_api(client: AsyncClient, admin_token: str, db_session: AsyncSession):
    """测试删除 A/B 测试 API"""
    # 创建测试数据
