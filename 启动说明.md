...
```bash
# 构建并启动所有服务（含 PostgreSQL、Redis、EMQX）
...
- **EMQX 管理面板**: http://localhost:18083
...
### v3.0 (最新)
- ✅ 新增 Docker Compose 一键部署（含 PostgreSQL + TimescaleDB、Redis、EMQX）
- ✅ 支持多站点管理
- ✅ 新增 6 种协议适配器（Modbus/SNMP/MQTT/HTTP/BACnet/OPC-UA）
- ✅ 全部 23 个 Epic 功能完成
