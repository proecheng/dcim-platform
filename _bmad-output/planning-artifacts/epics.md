...
| ID | 决策 | 阻断 Story |
|----|------|------------|
| D39-01 | RTO、RPO、备份保留、恢复与故障切换范围（已记录：2026-08-14） | 39.3 |
...
**依赖:** Story 39.7 是最终验收/`PASS` 前置，备份、WAL、恢复与故障切换基础可先行实施；D39-01 已于 2026-08-14 记录
...
39.7 -> 39.3 PASS                         （39.3 基础实施可先行，正式门禁等待 39.7）
39.7 + 39.10 -> 39.6
39.8                                      （可并行）
